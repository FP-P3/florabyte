      ...
      <div className="flex items-start justify-between flex-wrap gap-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">
            Kelola status dan pantau detail pesanan.
          </p>
        </div>
            ...
            >
              ...
              >
                <path
                  ...
                  fill="currentColor"
                />
                <path d="M5 5h7v2H7v10h10v-5h2v7H5V5z" fill="currentColor" />
              </svg>
              CMS Products
            </a>
          </div>
            ...
            {!loading &&
              orders.map((o) => {
                return (
                  <tr
                    key={o.id}
                    className="border-t odd:bg-white even:bg-gray-50/50 hover:bg-emerald-50/40"
                  >
                    ...
                    <td className="py-3.5 px-4">
                      <span
                        className={`inline-flex items-center px-2.5 py-1 rounded-full text-[10px] font-medium ${badgeColor(
                          o.status
                        )}`}
                      >
                        {o.status}
                    ...
                    <td className="py-3.5 px-4">
                      <Select
                        ...
                        onValueChange={(val: string) => updateStatus(o.id, val)}
                        value={o.status}
                      >
